...
#ifndef SRC_HRANK_ARRAY_DS_H_
#define SRC_HRANK_ARRAY_DS_H_

// An array is a type of data structure that stores elements of the same type in
// a contiguous block of memory. In an array, , of size , each memory location
// has some unique index,  (where ), that can be referenced as  (you may also
// see it written as ).
